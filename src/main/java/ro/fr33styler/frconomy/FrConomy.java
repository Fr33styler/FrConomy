...
import ro.fr33styler.frconomy.command.Eco;
import ro.fr33styler.frconomy.command.Money;
import ro.fr33styler.frconomy.command.Pay;
import ro.fr33styler.frconomy.command.Top;
import ro.fr33styler.frconomy.database.Database;
import ro.fr33styler.frconomy.vault.VaultHook;
...
public class FrConomy extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (getServer().getPluginManager().getPlugin("Vault") != null) {
            ...
            getServer().getServicesManager().register(Economy.class, vault_hook = new VaultHook(this), this, ServicePriority.High);
        }
